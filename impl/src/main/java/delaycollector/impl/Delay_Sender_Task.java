...
public class Delay_Sender_Task implements Runnable{
	...
	private final MyPacketDispatcher packetDispatcher;
	private final AsyncInventory inventoryReader;
	public Delay_Sender_Task(DelaycollectorConfig delayCollectorConfig,PacketProcessingService packetProcessingService,DataBroker dataSerivice,final MyPacketDispatcher packetDispatcher,final AsyncInventory inventory){
		this.delaycollectorConfig=delayCollectorConfig;
		this.packetProcessingService=packetProcessingService;
		this.dataservice=dataSerivice;
		this.packetDispatcher=packetDispatcher;
		this.inventoryReader=inventory;
	}
	@Override
	public void run() {
		...
		while(delaycollectorConfig.isIsActive()){
			...
			try {
				...
				Map<String, NodeConnectorRef> nodeConnectorMap=inventoryReader.readControllerSwitchConnectors();

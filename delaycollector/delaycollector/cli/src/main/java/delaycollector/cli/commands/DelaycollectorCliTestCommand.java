 ...
 */
package delaycollector.cli.commands;
...
public class DelaycollectorCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(DelaycollectorCliTestCommand.class);
    protected final DelaycollectorCliCommands service;

    public DelaycollectorCliTestCommand(final DelaycollectorCliCommands service) {
